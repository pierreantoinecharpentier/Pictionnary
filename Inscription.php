    ...
    <body>
        ...
        <form class="inscription" action="req_inscription.php" method="post" name="inscription" background-color: #ffff>  
          ...
          <!-- qu'y a-t-il d'autre comme possiblité que post pour l'attribut method ? -->  
            ...
            <div class="form-group">
            	<input class="form-control" type="tel" name="telephone" placeholder="Telephone (ex: 06 12 34 56 78)" pattern="[0-9]{10}"/>
            </div>

            <div class="form-group">
         	    <input class="form-control" type="url" name="Site Web" placeholder="Site Web" />
            </div>
            ...
            <div class="form-group">
            	<input class="form-control" type="radio button" name="sexe" placeholder="Sexe" />
            </div>

            <div class="form-group">
                <input class="form-control" type="date" placeholder="Date (jj/mm/aaaa)" min="1900-01-01" />
            </div>

            <div class="form-group">
                <input class="form-control" type="date" name="Date de naissance" placeholder="Date de naissance*" />
            </div>
            ...
            <div class="form-group">
                <input class="form-control" type="color" name="Couleur préférée" placeholder="Couleur préférée"  />
            </div>

            <div class="form-group">
                <input class="form-control" type="file" name="Photo de profil" placeholder="Photo de profil"  />
            </div>
